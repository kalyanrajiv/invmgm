		...
		<table>
			...
			<tr>
				...
				<?php //foreach($res as $s => $k){
						foreach($payment_res as $key => $paymentData){ //pr($paymentData);die;?>
							...
							<td>
							<input type="text" id= "<?php echo "old_amt_box_".$paymentData['id']; ?>" name="<?php echo "payment[".$paymentData['id']."]"; ?>" value="<?php echo $paymentData['amount'];?>"/>
