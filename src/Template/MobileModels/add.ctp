...
<div class="actions">
	...
	<ul>
        <li><?= $this->Html->link(__('List Mobile Models'), ['action' => 'index']) ?></li>
...
<div class="mobileModels form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Add Mobile Model') ?></legend>
        <?php
            ...
            ?>
            <tr>
				 <td><input name = "MobileModel[model][]" type="text" value=""></td>
				<td><input name = "MobileModel[brief_description][]" type="text" value=""></td>
