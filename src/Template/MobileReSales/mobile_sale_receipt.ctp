...
//pr($users_list[$mobileResaleData['user_id']]);
...
<table border="1" cellspacing="0" style="width: 700px;">
	...
	<tr>
			...
			<table style="text-align: center;float: right; width: 320px;margin-top: 27px;margin-right: 8px;">
				...
				<table border = '1' style="text-align: center;float: right; width: 320px;margin-top: -65px;margin-right: 8px;">
				...
				<tr>
					<td>
						...
						<tr>
							...
							<td><?php echo $users_list[$mobileResaleData['user_id']];?></td>
						</tr>
						</table>
					</td>
				</tr>
