...
<div id='cssmenu'>
   <ul>
	  <li><?php  echo $this->Html->link(__('Customers'), array('controller' => 'retail_customers', 'action' => 'index')); ?></li>
	  <li><?php echo $this->Html->link(__('Mobile'), array('controller' => 'mobile_purchases', 'action' => 'index')); ?> </span>
		 <ul>
	  ...
	  <li><?php echo $this->Html->link(__('Orders'), array('controller' => 'kiosk_orders', 'action' => 'search_from_orders')); ?></span>
		 <ul>
