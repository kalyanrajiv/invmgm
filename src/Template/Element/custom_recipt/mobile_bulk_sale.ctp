<tr>
 ...
 <?php
               if(!empty($sale_data)){
                ...
                $imei = $sale_data['imei'];
                $cost_price = $sale_data['selling_price'];
         ...
         <tr>
             <td style="font-size: 12px;" align="left">Selling Price:</td>
            ...
            if(!empty($pay_terms)){
                foreach($pay_terms as $pay_method => $value){ ?>
                        ...
                        <tr><td style="font-size: 12px;" align="left"><?php echo $pay_method." :" ?></td>
						<td style="font-size: 12px;" align="right"><?php echo $CURRENCY_TYPE.number_format($value,2); ?></td></tr>
                    <?php }   
            }?>
	<?php }?>
...
<tr>
			  <td style="font-size: 12px;" align="left">Refund Amount:</td>
