...
//echo $this->Form->end($options);
				 ?></td>
				<td><input class = "final_step" type="submit" name='submit' value="Submit" style="margin-top: 16px;"/></td>
...
<script>
	...
	$("#payment_method_0").focusout(function () {
		var val = document.getElementById('final_amount').value;
		var dueAmount = parseFloat(val);
		var firstBox = parseInt($('#payment_method_0').val());
