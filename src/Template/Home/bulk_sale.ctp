				...
				success: function(response) {
					...
					$.each(objArr, function(key, obj){ //str.concat();
						...
						if (dis_status == 1) {
							...
							innerHTMLStr += "<td style='width:35px;'><input type='text'   class='validate_qty1' name='sp' value='"+obj.price_without_vat+"' style='width:35px;'  id='sp_"+obj.id+"' onchange='check_sp_na("+obj.id+")'/></td>";
						}
