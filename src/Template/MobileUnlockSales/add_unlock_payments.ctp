...
<?php
    ...
    $repairId = $paymntData['mobile_unlock_id'];
	...
	<td id="cell">
		...
		<table>
			<tr>
             ...
             <?php echo $this->Form->input('Description',array('type'=>'hidden','name'=>"Payment[mobile_unlock_id]",'value' => $repairId))?>
             <?php echo $this->Form->input('Description',array('type'=>'hidden','name'=>"Payment[sale_id]",'value' => $saleId))?>
             <?php echo $this->Form->input('Description',array('type'=>'hidden','name'=>"Payment[kiosk_id]",'value' => $koiskId))?>
			<tr>
