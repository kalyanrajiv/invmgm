<div class="mobileUnlocks index">
	...
	<?php
	$webRoot = $this->request->webroot."credit-product-details/dr_search_customer";
    ...
    echo "</div>";
		...
		echo $this->Form->end();
		?>
	<?php $webRoot = $this->request->webroot."credit-product-details/dr_change_customer/$recipt_id"; ?>
