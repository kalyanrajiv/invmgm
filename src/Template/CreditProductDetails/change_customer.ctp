<div class="mobileUnlocks index">
	...
	Bussiness : <?php echo $customer_bussiness;?></br></b>
	 <b>Amt :  <?php echo $credit_amt; ?></b>
	<h2><?php echo __('Customers'); ?>&nbsp;</h2>
	<?php
	$webRoot = $this->request->webroot."credit-product-details/search_customer";
    ...
    echo "</div>";
		...
		?>
		<?php
        $a = array('label' =>'search','type' => 'button');
       // echo $this->Form->submit('Search',$a);
        echo "<input type = 'submit' name = 'submit' value = 'Search'/>";
		echo $this->Form->end();
		?>
	<?php $webRoot = $this->request->webroot."credit-product-details/change_customer/$recipt_id/$kiosk_id"; ?>
