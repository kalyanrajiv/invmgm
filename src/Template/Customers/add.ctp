...
<?php			
           ...
           // $countryOptions = '';
			...
			echo "<tr>";		
			echo "<td>".$this->Form->input('landline',array('id' => 'CustomerLandline','maxLength'=>11))."</td>";
			...
			<br>
				<table cellspacing='1' cellpadding='1'>
					<tr>
						...
						<td>Yes <input type='radio' name='same_delivery_address' value='1' onClick='showhide_info(1);' CHECKED/></td>
						<td>No<input type='radio' name='same_delivery_address' value='0' onClick='showhide_info(0);'/>
					</tr>
				</table>
			</br>
			</tr>
		...
		echo "<tr>";
			echo "<td>";
				echo "<table>";
					echo "<tr>";
						echo "<td>";
						echo $this->Form->input('del_zip',array('placeholder' => 'Postcode', 'label'=>false, 'id'=>'CustomerDelZip','rel' => $url,'size'=>'10px'));
						echo "</td>";
						echo "<td>";
						echo "<button type='button' id='find_del_address' class='btn' style='margin-top: 6px;margin-left: -8px;width: 112px;height: 22px;'>Find my address</button>";
						echo "</td>";
					echo "</tr>";
				echo "</table>";
			echo "</td>";
